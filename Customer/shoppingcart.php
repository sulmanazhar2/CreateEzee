...
?>
    ...
    <div style="background-color:#DBF1FF;">
        <div class="container" style="border-bottom:0.8px solid #CCC; padding:15px;">
            ...
            <a href="index.php" style="color:#3C7A72">Home</a> <span class="fa fa-arrow-right"></span><a href="#"> Shopping Cart</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-6">
                    ...
                    <div class="panel panel-default" style="box-shadow: 2px 2px 2px 2px rgba(0,0,0,.1); background-color:#F0F2F1; border:none;">
                        <div style="overflow-x:auto;" class="panel-body">

                            <h2>Shopping Cart</h2>
                            <p>You currently have <?php items(); ?> item(s) in your cart.</p>
...
?>
                                    ...
                                    <tr>
                                        <td><img src="../Admin/products/<?php echo $pic1;?>" height="70" width="70" /> <?php echo $nam1?> </td>
                                        <td><?php echo $quan?></td>
                                        <td><?php echo $price?> </td>
                                        <td><?php echo $size?></td>
                                        <td><a href="deletecart.php?id=<?php echo $id; ?>"><i class="fa fa-trash"></span></a></td>
                                        <td><?php echo $sub?></td>
                        ...
                        <div class="panel-footer">
                            ...
                            <a href="checkout.php?red='cart'"><button class="btn btn-primary">Proceed to Checkout <i class="fa fa-arrow-right"></i></button></a>
...
?>
                        <div class="panel-body">
                            ...
                            <hr />
                            <p>Order Subtotal:<b class="pull-right">$<?php echo $grand?></b></p>

                            <hr />
                            <p>shipping and handling:<b class="pull-right">$<?php echo $shipping?></b></p>

                            <hr />
                            <p>Tax:<b class="pull-right">$<?php echo $tax?></b></p>

                            <hr />
                            <p><strong>TOTAL:</strong><b class="pull-right">$<?php echo $total?></b></p>
