            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading" style="background-color:#3C7A72">
                        <h1 class="text-center" style="color:#DBF1FF">Want To Become Seller? </h1>
                        <p class="text-center" style="color:#DBF1FF">Welcome to the Createzze store, If already our seller then go to <a href="slogin.php"><b>sign-in</b></a> page.</p>
                    </div>
                    ...
                    <div class="panel-body">
                        <form method="post" enctype="multipart/form-data">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label>Name</label>
                                    <input class="form-control" type="text" required="required" name="nam">
                                    <br />
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="tel" required="required" name="numm">
                                    <br />
                                </div>
                                <div class="col-md-12">
                                    <label>Address</label>
                                    <input class="form-control" type="text" required="required" name="add">
                                    <br />
                                </div>
                                <div class="col-md-6">
                                    <label>City</label>
                            ...
                            <center><a href="#"><button style="background-color:#1ABC9C" class="btn" name="insertt"><span class="fa fa-sign-in"></span> Click Here</button></a></center><br />
...
if(isset ($_POST['insertt']))
{
	...
	move_uploaded_file($temp,"sellerpic/$pic1");
	$gender=$_POST['gen'];
	
	
	$sql ="insert into seller (Name,Email,Password,Contact,Address,City,Country,Pic,Gender) values ('$name','$email','$password','$contact','$address','$city','$country','$pic1','$gender')";
