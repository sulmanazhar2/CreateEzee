...
{	 $id=$row['ID'];
	...
	?>
                         ...
                         <img src="sellerpic/<?php echo $pic?>" width="100%" ; />
                         <?php } ?>
                         <br /><br />
                     ...
                     <div class="panel-body">
                         <ul style="list-style-type:none;">
                             <li><a href="selleraccount.php?pg=sorder"><i class="fa fa-bars"></i> My Order</a></li><br />
                              <li><a href="../Admin/Tool/Editor.php"><i class="fa fa-heart"></i> Create Design</a></li><br />
                              <li><a href="selleraccount.php?pg7=sviewdesigns.php"><i class="fa fa-picture-o" aria-hidden="true"></i> View Design</a></li><br />
                             <li><a href="selleraccount.php?pg1=spayment"><i class="fa fa-credit-card-alt"></i> Payment</a></li><br />

                             <li><a href="selleraccount.php?pg2=swishlist"><i class="fa fa-heart"></i> My Wishlist</a></li><br />
                             <li><a href="#"><i class="fa fa-trash" aria-hidden="true"></i> Delete Account</a></li><br />
