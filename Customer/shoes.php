...
<a href="index.php" style="color:#3C7A72">Home</a> <span class="fa fa-arrow-right"></span><a href="index.php"> Men's wears</a> <span class="fa fa-arrow-right"></span><a href="tshirts.php"> Shoes</a>
  ...
  <svg width="100%" height="24">
    <line x1="4" y1="0" x2="300" y2="0" stroke="#212121" stroke-width="12" stroke-dasharray="1 28"></line>
            ...
            <div class="product-img image-box"  >
              <img class="img-fluid w-100" src="products/shoe.png" alt="" />
              <div class="p_icon">
                <a href="#">
...
<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                             <div class="single-product">
            <div class="product-img image-box" >
              <img class="img-fluid w-100" src="products/pillow.png" alt="" />
              <div class="p_icon">
                <a href="#">
                  <i class="fa fa-eye"></i>
                </a>
