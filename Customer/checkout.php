...
if(!isset($_SESSION['ema']))
{
	...
	echo "<script>window.location.href='blogin.php?red=cart'</script>";
	}else
	{
...
?>
     ...
     <div style="background-color:#DBF1FF;">
         <div class="container" style="border-bottom:0.8px solid #CCC; padding:15px;">
             ...
             <a href="index.php" style="color:#3C7A72">Home</a> <span class="fa fa-arrow-right"></span><a href="#"> Checkout</a>
         ...
         <div class="panel-body">
             <center>
                 <h2>Payment Options For </h2>
             </center>
             <br />
             <center>
                 <h4><a href="order.php?cust_id=<?php echo $id ?>">Pay Off Line</a></h4>
             </center>
             <center><img src="img/paypal.png" width="500" height="500"></center>
