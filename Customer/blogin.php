...
?>
    ...
    <div style="background-color:#DBF1FF;">
        <div class="container" style="border-bottom:0.8px solid #CCC; padding:15px;">
            ...
            <a href="index.php" style="color:#3C7A72">Home</a> <span class="fa fa-arrow-right"></span><a href="#"> Login</a>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading" style="background-color:#3C7A72">
                        ...
                        <h3 class="text-center">Already Our Customer</h3>
                        <p class="text-center" style="color:#DBF1FF">Welcome to the Createzze store,We inform you to <a href="bregister.php">register</a> first if you are a new members.</p>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12">
                                ...
                                <h3 class="text-center"><a href="bregister.php">New? Register Here</a></h3>
                            </div>
...
if(isset($_POST['login']))
{
 ...
 $sql="select * from customer where  Email='$ema' and Password='$pass'";
$res=$conn->query($sql);
	if($res->num_rows>0)
	{
	while($row=$res->fetch_assoc())
	{
		...
		if(isset($_GET['red'])=='cart')	
		echo "<script>window.location.href='checkout.php'</script>";
		else{
		
		
		echo "<script>window.location.href='myaccount.php?pg=myorder'</script>";
		}
	}
